...
| ID | Project | Bug | PR/Issue | Status | CVE? |
|---|---|---|---|---|---|
...
**Independently Discovered** Means N184 flagged this as an issue and it was brought to maintainers attention during embargo from another security researcher.  
...
**Analysis Period:** April to May 2026
